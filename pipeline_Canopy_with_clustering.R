...
#######################################################
#######################################################
num_cluster=3:4 # Range of number of clusters to run
num_run=5 # How many EM runs per clustering step for each mutation cluster wave
...
#######################################################
#######################################################
K = 3 # number of subclones
numchain = 3 # number of chains with random initiations
sampchain = canopy.sample.cluster(R = R, X = X, sna_cluster = sna_cluster, 
                                  ...
                                  min.simrun = 2000, writeskip = 200,
                                  projectname = projectname, cell.line = TRUE,
                                  plot.likelihood = TRUE)
save.image(file = paste0(arguments[1], arguments[2], '.RData'))
